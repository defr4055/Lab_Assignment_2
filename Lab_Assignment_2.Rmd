...
From Nisia:Thank you for setting up the file. To read your experience as a mechanical engineer was refreshing. Sometimes we have to find what works best for us. I am glad you did. 

<<<<<<< Updated upstream
From Thomas: I can strongly relate to your Career goals. I would also consider fleshing out your answers more.
=======
From Andres: I like that you asked a question that I didn't know how to ask myself. I'm with Julia on the spelling.
...
<<<<<<< Updated upstream
From Nisia:Thank you for your input in the in-class quiz. Being in law school is a clever choice, especially with your career path. I am glad you said you want to live off the grid and travel the world, because you will be able to see other realities.
=======
From Declan: You jumped into this project right away, and became a roll model for others. Thank you for also scratching the answers off on the TRat. 
>>>>>>> Stashed changes

From Thomas: You set a very good standard for this lab and it helped my format my section.

=======
From Andres: I like that you were proactive in starting this project. I also like your FBI dreams
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
From Nisia: I really hope you like this class and I am excited to see how one day you will change the infrastructure of these countries.
=======
From Andres: I like the depth of thought you put into your answers. You seem very clear about your intentions for this course.

>>>>>>> Stashed changes


From Declan: You defiently did the reading and were able to figure out this project on your own. I think this is going to be a good year.
=======
...
From Andres: I love how much you have thought about your future. I'm often overwhelmed by the decisions I have to make about my life. 

From Thomas: I realy like your 5 year career goal and can relate to it.

From Declan: Thank you for staying invloved and countinuously working hard to get the project done. Communication is key, so I'm happy to have a team member like yourself.
>>>>>>> Stashed changes
---
...
**Picture**
```{r, out.width = "400px", message=FALSE}
knitr::include_graphics("IMG_0633 2.jpg")
```
...
<<<<<<< Updated upstream
From Nisia: I really enjoy you like to face challenges. Yor motivation will be a valuable input for this team.

From Thomas: I like you hobbies and hope to try your bread. Also its good to see someone whos main goal is to be happy.
=======

From Declan: I was nervous at first because you weren't on the GroupMe, but you did the individual part on your own and were up to speed just like you were there the whole time.
>>>>>>> Stashed changes
